...
surfaceTransformPoints -rollPitchYaw '(0 0 13.8)' single_vanem.stl single_vaneu.stl
surfaceTransformPoints -rollPitchYaw '(0 0 -13.8)' single_vanem.stl single_vanel.stl
